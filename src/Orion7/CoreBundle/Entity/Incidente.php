...
class Incidente
{
    ...
    public function __construct()
    {
        ...
        $this->canalizaciones = new \Doctrine\Common\Collections\ArrayCollection();
     ...
     * Add canalizaciones
     *
     * @param \Orion7\CoreBundle\Entity\Canalizacion $canalizaciones
     * @return Incidente
     */
    public function addCanalizacione(\Orion7\CoreBundle\Entity\Canalizacion $canalizaciones)
    {
    ...
    /**
     * Remove canalizaciones
     *
     * @param \Orion7\CoreBundle\Entity\Canalizacion $canalizaciones
     */
    public function removeCanalizacione(\Orion7\CoreBundle\Entity\Canalizacion $canalizaciones)
    {
        $this->canalizaciones->removeElement($canalizaciones);
    }
     ...
     * @return \Doctrine\Common\Collections\Collection 
     */
    public function getCanalizaciones()
    {
